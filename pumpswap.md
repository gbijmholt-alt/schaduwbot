# PumpSwap-dekking — 2026-09-13 08:17 UTC
...
Totaal open (SOL erin min eruit op de curve): **81446 SOL** over 32204 posities. Hiervan gecheckt: 2899 posities (58375 SOL).

| status nu | posities | open SOL |
|---|---|---|
| verkocht | 2802 | 57223.8 |
...
Programma `pAMMBay6oceH9fJKBRHGP5D4bD4sWpmSwMn52FMfXEA`. 905 transacties opgehaald, 195 bruikbaar (één memecoin-mint, bedragen uit pre/post-balansen af te leiden). Eis om een layout vast te stellen: match ≥ 95% over ≥ 50 voorbeelden.

| discriminator | naam | waar | n | tokens | lamports | mint | pool | user | herkenning | vastgesteld |
|---|---|---|---|---|---|---|---|---|---|---|
| `67f4521f2cf57777` | BuyEvent | inner_cpi+log | 139 | @8 (99%) | @96 (99%) | – | @112 (100%) | @144 (73%) | pool | ja |
| `3e2f370aa503dc2a` | SellEvent | inner_cpi+log | 58 | @8 (97%) | @376 (100%) | – | @112 (100%) | @144 (78%) | pool | ja |
...
Waar de tokens niet matchen, zit de dichtstbijzijnde waarde er mediaan BuyEvent: 45.16%, SellEvent: 77.04%, c62e1552b4d9e870: 20.00%, e2d6f62107f293e5: 33.52% naast. Een klein percentage wijst op kosten die het event anders rekent dan de balans; een groot percentage op een verkeerd veld.

**Layout vastgelegd** in `data/pumpswap_layout.json`: BuyEvent (match 99%, n=139, herkenning via pool), SellEvent (match 97%, n=58, herkenning via pool)
