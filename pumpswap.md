# PumpSwap-dekking — 2026-09-13 05:40 UTC
...
Totaal open (SOL erin min eruit op de curve): **79987 SOL** over 31642 posities. Hiervan gecheckt: 2885 posities (58308 SOL).

| status nu | posities | open SOL |
|---|---|---|
| verkocht | 2785 | 56898.6 |
...
Programma `pAMMBay6oceH9fJKBRHGP5D4bD4sWpmSwMn52FMfXEA`. 806 transacties opgehaald, 149 bruikbaar (één memecoin-mint, bedragen uit pre/post-balansen af te leiden). Eis om een layout vast te stellen: match ≥ 95% over ≥ 50 voorbeelden.

| discriminator | naam | waar | n | tokens | lamports | mint | pool | user | herkenning | vastgesteld |
|---|---|---|---|---|---|---|---|---|---|---|
| `67f4521f2cf57777` | BuyEvent | inner_cpi+log | 106 | @8 (98%) | @96 (98%) | – | @112 (100%) | @144 (74%) | pool | ja |
...
**Layout vastgelegd** in `data/pumpswap_layout.json`: BuyEvent (match 98%, n=106, herkenning via pool)
