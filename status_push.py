...
def main():
    ...
    for name in ("wallets.md", "wallets.json", "ledger.md", "ledger.json", "video_replay.md", "video_replay.json", "pumpswap.md", "pumpswap.json", "hypotheses.md", "hypotheses.json", "lotgevallen.md", "lotgevallen.json", "vamp.md", "vamp.json"):
